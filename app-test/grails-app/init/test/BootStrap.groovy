    ...
    def init = {
        ...
        applicationService.onTenantInstall { String tenantId ->
            ...
            tenantPropertyService.setString(
                    'LOGIN_COPY',
                    'Copyright &copy; The Goowee Team.<br/>All rights reserved.<br/><br/><a href="' + appLink + '">&lt;&lt; Back to website</a>'
            )
            ...
            TCompany goowee = new TCompany(name: 'Goowee S.r.l.').save(flush: true)
            TCompany gooweeTwo = new TCompany(name: 'Goowee Two S.r.l.').save(flush: true)
            TPerson user1 = new TPerson(active: true, company: goowee, name: 'user1', address: 'Via del Primo', postcode: 30020).save(flush: true)
            TPerson user2 = new TPerson(active: true, company: goowee, name: 'user2', address: 'Via del Secondo', postcode: 30020).save(flush: true)
            TPerson user3 = new TPerson(active: true, company: goowee, name: 'user3', address: 'Via del Terzo', postcode: 30020).save(flush: true)
            TPerson admin = new TPerson(active: true, company: goowee, name: 'admin', address: 'Via dell\'Admin', postcode: 30020).save(flush: true)

            goowee.addToEmployees(user1).save(flush: true, failOnError: true)
            goowee.addToEmployees(user2).save(flush: true, failOnError: true)
            goowee.addToEmployees(user3).save(flush: true, failOnError: true)
